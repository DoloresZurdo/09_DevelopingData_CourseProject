...
(function(){
try {
   var timings = [ { marker: 'knitr', elapsed: 202 }, { marker: 'pandoc', elapsed: 29 }, { marker: 'post-processor', elapsed: 40 }, { marker: 'pre-processor', elapsed: 6 }, { marker: 'render', elapsed: 287 } ];
